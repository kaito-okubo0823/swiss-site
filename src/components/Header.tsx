    ...
    <header className="fixed top-0 w-full z-50 bg-bg/60 backdrop-blur-xl border-b border-gold/15">
      <nav className="max-w-7xl mx-auto px-8 py-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            href="/reservation"
            className="bg-gold text-bg px-5 py-2.5 text-xs font-semibold tracking-[0.18em] uppercase border border-gold hover:bg-transparent hover:text-gold transition-all"
          >
            {t('reserve')}
          </Link>
        </div>
